...
export treeminmax, update_tree!, normalize_tree_value
...
function update_tree!(treeminmax::TreeMinMax, value::Float64)::Nothing
...
function normalize_tree_value(treeminmax::TreeMinMax, value::Float64)::Float64
